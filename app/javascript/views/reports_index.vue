<template>
  <section>
    ...
    <div class="fixed w-full z-10 py-2 px-4 bg-white flex justify-center border-b border-slate-900/20 print:hidden">
    ...
    <div class="flex justify-center print:block print:justify-start">
      <div class="main-screen print:w-full">
        <div class="fixed z-10 text-sm text-slate-500 print:hidden">
          <p>＜印刷プレビュー＞</p>
        </div>
        <div class="w-full pt-4 print:pt-0 print:px-8">
